...
var passwork = {
	...
	brutally_common : {
		...
		/* "password"   */ 'password':1, 'password1':1, 'passw0rd':1, 'drowssap':1, 'nopassword':1,
				   'secret':1, 'letmein':1, 'testing':1, 'test':1, 'testest':1, 'test123':1,
		/* keyboard     */ 'qwerty':1, 'qwertyu':1, 'qwertyui':1, 'qweewq':1, 'qazwsx':1, 'qweasd':1, 'qweasdzxc':1,
				   'asdsa':1, 'asddsa':1, 'asdfgh':1, 'asdfghj':1, 'asdfghjk':1, 'asdfghjkl':1, '159357':1,
		/* emo          */ 'love':1, 'iloveyou':1, 'lovely':1, 'iwantu':1, 'fuckyou':1, 'biteme':1, 'fuckme':1, 'blowme':1, 'helpme':1,
				   'whatever':1, 'whocares':1, 'anything':1, 'nothing':1,
		/* first names  */ 'michael':1, 'jordan':1,
