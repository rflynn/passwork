...
var passwork = {
	...
	brutally_common : {
		...
		/* "password"   */ 'password':1, 'password1':1, 'secret':1, 'letmein':1, 'testing':1,
		/* keyboard     */ 'qwerty':1, 'qazwsx':1,
		...
		/* "desk" words */ 'microsoft':1, 'windows':1, 'apple':1, 'intel':1, 'dell':1, 'linksys':1, 'samsung':1, 'verizon':1, 'sony':1, 'sprint':1, 'hewlettpackard':1,
		/* war games    */ 'joshua':1,
		/* x-files      */ 'trustno1':1,
		/* the matrix   */ 'z10n0101':1,
		/* irc/bash     */ 'hunter2':1,
	}
};
